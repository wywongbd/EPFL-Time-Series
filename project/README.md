...
<figure align="center">
	<p align="center">
	  ...
	  <figcaption> This plot illustrates effect normalization on the filtered time series. The normalization is done using daily mean and daily standard deviation. 
	  </figcaption>
	</p>
</figure>
